...
from mertens_handlers import MertensHandlersMixin, mertens_tool_definitions, MERTENS_TOOL_NAMES
...
class LocalVQEServer(MertensHandlersMixin):
    def __init__(self):
        ...
        # Mertens spin glass state (from mixin)
        self.init_mertens_state()
    ...
    def setup_handlers(self):
        ...
        async def call_tool(name: str, arguments: Dict[str, Any]) -> List[types.TextContent]:
            ...
            elif name in MERTENS_TOOL_NAMES:
                return await self.dispatch_mertens_tool(name, arguments)
            else:
